...
import type { AnsiStyleType } from "./Ansi";
 ...
 */
const createCmdBox = (name: string, code: string): Box<AnsiStyleType> => {
 ...
 */
export const cursorUp = (lines = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorDown = (lines = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorLeft = (columns = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorRight = (columns = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorForward = (columns = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorBackward = (columns = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorTo = (column = 0, row = 0): Box<AnsiStyleType> =>
 ...
 */
export const cursorMove = (column = 0, row = 0): Box<AnsiStyleType> =>
  createCmdBox(
    "cursorMove",
    pipe(
      [
 ...
 */
export const cursorNextLine = (rows = 1): Box<AnsiStyleType> =>
 ...
 */
export const cursorPrevLine = (rows = 1): Box<AnsiStyleType> =>
 ...
 * ```
 */
export const cursorSavePosition: Box<AnsiStyleType> = createCmdBox(
  "cursorSavePosition",
  `${ESC}7`
);
 ...
 * ```
 */
export const cursorRestorePosition: Box<AnsiStyleType> = createCmdBox(
 ...
 */
export const cursorShow: Box<AnsiStyleType> = createCmdBox(
  "cursorShow",
  `${CSI}?25h`
);
 ...
 */
export const cursorHide: Box<AnsiStyleType> = createCmdBox(
  "cursorHide",
  `${CSI}?25l`
);
 ...
 */
export const eraseScreen: Box<AnsiStyleType> = createCmdBox(
  "eraseScreen",
  `${CSI}2J`
);
 ...
 */
export const eraseUp: Box<AnsiStyleType> = createCmdBox("eraseUp", `${CSI}1J`);

/**
 * Clears the screen from current cursor position to the end.
 * The cursor position remains unchanged.
 */
export const eraseDown: Box<AnsiStyleType> = createCmdBox(
  "eraseDown",
  `${CSI}0J`
);
 ...
 */
export const eraseLine: Box<AnsiStyleType> = createCmdBox(
  "eraseLine",
  `${CSI}2K`
);
 ...
 * The cursor position remains unchanged.
 */
export const eraseStartLine: Box<AnsiStyleType> = createCmdBox(
  "eraseStartLine",
  `${CSI}1K`
);
 ...
 * The cursor position remains unchanged.
 */
export const eraseEndLine: Box<AnsiStyleType> = createCmdBox(
  "eraseEndLine",
  `${CSI}0K`
);
 ...
 */
export const eraseLines = (rows: number): Box<AnsiStyleType> =>
 ...
 */
export const clearScreen: Box<AnsiStyleType> = createCmdBox(
  "clearScreen",
  `${CSI}2J${CSI}H`
);
 ...
 */
export const home: Box<AnsiStyleType> = createCmdBox("home", `${CSI}H`);

/**
 * Triggers the terminal bell (beep sound).
 */
export const bell: Box<AnsiStyleType> = createCmdBox("bell", "\x07");
