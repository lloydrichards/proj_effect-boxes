...
```ts
export declare const AnsiRendererLive: Layer.Layer<
  internal.Renderer,
  never,
  never
>;
...
```ts
export declare const HtmlPrettyRendererLive: Layer.Layer<
  internal.Renderer,
  never,
  never
>;
...
```ts
export declare const HtmlRendererLive: Layer.Layer<
  internal.Renderer,
  never,
  never
>;
...
const htmlBox = Box.vcat(
  [
    ...
    Box.text("This is an example of HTML rendering.").pipe(
      Box.annotate(Html.p())
    ),
...
```ts
export declare const PlainRendererLive: Layer.Layer<
  internal.Renderer,
  never,
  never
>;
...
```ts
export declare const renderBoxToLines: <A>(
  box: Box.Box<A>
...
const complexBox = Box.vcat(
  [
    ...
    Box.hcat(
      [Box.text("Left"), Box.text("Right").pipe(Box.annotate(Ansi.red))],
      Box.top
    ),
    Box.text("Footer"),
  ],
